...
CMD="cd /tmp && python3 render.py /usr/local postgres /tmp/coucou.png -host $DOCKER_IP_DATA -db $PG_DATA -user $PG_USER -pwd $PG_PASSWORD -geom geoml93 -schema ref -table hydro_bassin"
